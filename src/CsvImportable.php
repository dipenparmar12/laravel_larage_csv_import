...
// *** To Register. ***
/// /config/app.php
/// App\Providers\CsvImportableServiceProvider::class,
//  'providers' => [
//        // ...
//        App\Providers\CsvImportServiceProvider::class,
//    ],
//------------------------------------
// *** How to use it. ***
//$csv = [
//    "users" => User::class,
//    "msg" => ChatMassage::class,
//];
//return (new CsvImportable())->truncate(true)->setDirectory(base_path('database/csv_import'))->insert($csv);
//return (new CsvImportable())->parse($csv);
//$data = CsvImportable::truncate(true)->directory(base_path('database/csv_import'))->insert($csv);
//return (CsvImportable::truncate(1)->insert($csv)); // Meta data collection
//return (CsvImportable::insert($csv)); // Meta data collection
//return = CsvImportable::parse($csv); // collection
//return CsvImportable::parse("users"); // collection
//return CsvImportable::parse(['users', "msg"]); // collection
...
class CsvImportable
{
    ...
    public function parseCsv($file_path)
    {
        $header = null;
        $table_data = [];
        if ($file_handler = $this->openCsv($file_path)) {
